...
* IP Duplicated Detection Algorithm
...
**실습**
* IPv4 vs IPv6 패킷 구조 비교
* IP 충돌 확인
* ARP / RARP 존재 X -> NDP(Neighbor discovery protocol)
* IPv6 Fragmentation
* Router Prefix Modification
...
**포트 번호 체계**
* 포트 번호가 필요한 이유
    - IP 주소 : 호스트(Host) 또는 물리적인 포트를 구분하기 위한 번호
    - 포트 주소 : 서비스(Service) 구분하기 위한 번호
* 포트 번호 종류
    - Well Known Port : 0 - 1023
    - Registered Port : 1024 - 49151
    - Dynamic and Private Port : 49152 - 65535

**실습**
* FTP 패킷분석
* WEB(http) 패킷 분석
    - Http Requet(GET, POST, PUT ...)
